<?php
	function enviar_email($titulo = 'Asignar asunto', $cuento='Asignar el cuento', $enviar_ip=true, $archivoadjunto='', $enviadopor='info@heros.com.ve', $respondera='info@heros.com.ve', $enviara='' )
	{
		// enviar email
