		    	...
		    	<div class="modal-header">
		      	...
		      	<div class="modal-body">
					<div class="form-group form-inline col-xs-12">
						<label for="rif" class="sr-only control-label">C.I/RIF </label>
						<input type="text" placeholder="C.I./RIF" class="form-control" id="rif" name="rif" required value="" maxlength="10" size="10">
					</div>
					<div class="form-group form-inline col-xs-12">
