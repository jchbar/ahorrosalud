...
<script type="text/javascript" src="js_bancos/prevision.js"> </script>
</head>

<body>
<?php 
include("js_bancos/modal_agregar_banco.php");
include("js_bancos/modal_eliminar_banco.php");
include("js_bancos/modal_cambiar_banco.php");
include("js_bancos/modal_modificar_banco.php");
?>
...
-->		
	...
	<script src="js_bancos/app_bancos.js"></script>
	<script>
